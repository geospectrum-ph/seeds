...
export default function DemLabor() {
  ...
  useEffect(()=>{
    const fetchData = async() => {
      const res = await axios(`http://ec2-52-90-134-187.compute-1.amazonaws.com/jobmapper/brgy/single`, {
        params: {
          brgy_id: profileLoc,
          startdate: startDate,
          enddate: endDate,
      ...
      const res_graph = await axios(`http://ec2-52-90-134-187.compute-1.amazonaws.com/jobmapper/graph`, {
        params: {
          brgy_id: profileLoc,
          startdate: startDate,
          enddate: endDate,
