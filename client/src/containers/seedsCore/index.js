...
export default function SeedsCore() {
  ...
  const checkUserPrivilege = () => {
    try{
      axios.all([
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/616cec44456bbb1c3c4e5daf`),
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/616cf421e48a071bb478ec56`),
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/617fc3d213d435bdbb7914be`),
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/617fc8d513d435bdbb7914bf`),
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/617fc8f513d435bdbb7914c0`),
         axios.get(`http://ec2-52-90-134-187.compute-1.amazonaws.com/usermaster/checkUserPrivilege/${_id}/61892c33219fea59d81938b3`),
      ]).then(responseArr => {
