...
import NorthArrowIcon from './arrows/default.svg' //added
L.Control.Rose = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        // console.log("container.appendChild CONTENT ", content)
        ...
        var path1= NorthArrowIcon //added
        var i = L.DomUtil.create('img', s, container);
        // i.setAttribute('src', path);
        i.setAttribute('src', path1); //added
