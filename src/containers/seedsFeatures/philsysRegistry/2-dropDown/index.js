      ...
      <Grid container direction="column" xs={12} >
        ...
        <Grid  item  className={classes.formControl}>
          ...
          <Grid container direction="row" justify="space-between">
            <Grid item xs ={5}>
              <FormControl size="small" variant="outlined" className={classes.formControl}>
                <InputLabel htmlFor="age-native-simple">Household Size</InputLabel>
                <Select
                size="small"
                  // onChange={handleCommercialChange}
                  label="Demographic"
            ...
            <Grid item xs={3}>
              <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Male</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
            ...
            <Grid item xs={3}>
              <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Female</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
            ...
            <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Tenure Status</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
        ...
        <Grid item xs ={12} className={classes.formControl}>
          ...
          <FormControl size="small" variant="outlined" className={classes.formControl}>
            ...
            {/* <Grid item xs={3}> */}
            <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Affiliation</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
            ...
            <Grid item xs={3}> */}
            <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Ethnicity</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
            ...
            {/* </Grid> */}
            <FormControl size="small" variant="outlined" className={classes.formControl}>
              <InputLabel htmlFor="age-native-simple">Literacy</InputLabel>
              <Select
              size="small"
                // onChange={handleCommercialChange}
                label="Demographic"
