...
export default function CardDisease() {
  ...
  return (
    ...
    > 
      ...
      <Grid item style={{width:'80%', height:'10vh'}}>
        <Paper className={classes.summary}>
          <Typography variant="h5">{(healthSelect && healthSelect.properties.active !== "N/A") ? healthSelect.properties.active + healthSelect.properties.recovered + healthSelect.properties.death: <div>N/A</div>}</Typography>
