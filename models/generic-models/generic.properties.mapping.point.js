...
const genericSchema = new Schema({
    ...
    propertiesMapping: { // for all point datasets under keywords
...
const Generic = mongoose.model('Generic_PropertiesMapping_Points', genericSchema, 'generic_propertiesMapping_pts');
